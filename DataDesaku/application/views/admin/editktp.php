                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="box">
                            ...
                            <div class="box-body">
                                <form role="form" id="" action="<?php echo base_url(); ?>admin/updatektp" method="post" enctype="multipart/form-data">
                                <input type="hidden" name="id_ktp" value="<?php echo $id_ktp; ?>">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <input name="tgl_ktp" type="text" value="<?php echo $tgl_ktp; ?>" class="form-control datepicker-input" required>
                                  </div>
                                  <div class="form-group">
